  ...
  const onSubmit = async (data: ProductFormValues) => {
    try {
      ...
      const productData = {
        ...
        // ⚠️ IMPORTANT: SKU AUTO-GENERATION
        // Do NOT manually set SKU in this payload
        // The backend will automatically generate a unique SKU for this product
        // SKU Format: PROD-{YYYYMMDD}-{PRODUCT_ID}
        // The auto-generated SKU will be visible in the product edit page after creation
      }
      ...
      toast({
        title: 'Success',
        description: 'Product created successfully. SKU has been auto-generated. You can now edit it to add more details.',
      })
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-8 sm:p-10">
              ...
              <div className="bg-muted/40 border border-border rounded-lg p-4 space-y-2">
                ...
                <ul className="text-sm text-muted-foreground leading-relaxed space-y-1 list-disc list-inside">
                  <li>After creating this product, you'll be able to edit it and add images, pricing, inventory, and descriptions</li>
                  <li>A unique SKU (Stock Keeping Unit) will be automatically generated by the system</li>
                  <li>SKU format: PROD-YYYYMMDD-{ID} (e.g., PROD-20260310-00079)</li>
                  <li>SKU will be read-only and used for inventory tracking</li>
                </ul>
              </div>
