                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          className="pl-10 pr-12 h-11 font-mono text-sm bg-gray-50 text-gray-600 cursor-not-allowed"
                    ...
                    <FormDescription>
                      {sku
                        ? "SKU is automatically generated by the system. Click the copy button to copy it."
                        : "SKU will be automatically generated when you save this product."}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )
